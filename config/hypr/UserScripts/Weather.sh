...
"fog" | "freezing fog" | "haze")
    condition=""
    ;;
"patchy rain possible"| "patchy rain nearby" | "patchy light drizzle" | "light drizzle" | "patchy light rain" | "light rain" | "light rain shower" | "mist" | "rain" | "patchy rain nearby")
    condition="󰼳"
    ;;
